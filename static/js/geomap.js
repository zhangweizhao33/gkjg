        ...
        var secret_key=JSON.stringify("")


        var default_geo_layer2=new ol.layer.Tile({
            source: new ol.source.XYZ({
                crossOrigin: 'anonymous',
                url:'http://t3.tianditu.cn/DataServer?T=img_w&X={x}&Y={y}&L={z}&tk=88a4217f2da89109e14403fc4a890d94'
            }),
            projection: "EPSG:4326",
            id:"影像",
            opacity:1,
        ...
        var default_geo_layer = new ol.layer.Tile({
            source: new ol.source.XYZ({
                crossOrigin: 'anonymous',
                url: "http://t3.tianditu.com/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=88a4217f2da89109e14403fc4a890d94"
            }),
            projection: "EPSG:4326",
            opacity:1,
        });
        ...
        var default_geo_layer3 = new ol.layer.Tile({
             source: new ol.source.XYZ({
                crossOrigin: 'anonymous',
                url: "http://t2.tianditu.com/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=88a4217f2da89109e14403fc4a890d94"
            }),
            projection: "EPSG:4326",
            opacity:1,
        });
            var default_geo_layer4 = new ol.layer.Tile({
             source: new ol.source.XYZ({
                crossOrigin: 'anonymous',
                url: "http://t2.tianditu.com/DataServer?T=cia_w&x={x}&y={y}&l={z}&tk=88a4217f2da89109e14403fc4a890d94"
            }),
            projection: "EPSG:4326",
            opacity:1,
        });
